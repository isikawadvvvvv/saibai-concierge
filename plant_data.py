...
PLANT_DATABASE = {
    'ベビーリーフ': {
        ...
        'recurring_consumables': [{'name': '速効性のある液体肥料', 'link': 'https://amzn.to/3Rk4uTf', 'reason': '継続的に収穫するためには、定期的な栄養補給が不可欠。即効性のある液体肥料が最適です。'}, {'name': '有機野菜の土', 'link': 'https://amzn.to/4lOXjOS', 'reason': '次の栽培の準備に。新しい土で連作障害を防ぎましょう。'}],
    ...
    'コマツナ': {
        ...
        'recurring_consumables': [{'name': '野菜用の液体肥料', 'link': 'https://amzn.to/3Rk4uTf', 'reason': '葉を大きく育てるために、定期的な栄養補給が効果的です。'}, {'name': '防虫ネット', 'link': 'https://amzn.to/3VEA7hV', 'reason': 'アオムシなどの害虫は、ネットで物理的に防ぐのが最も安全で確実です。'}],
    ...
    'ミニダイコン': {
        ...
        'recurring_consumables': [{'name': '野菜用の化成肥料', 'link': 'https://amzn.to/4c5kX7s', 'reason': '根を太らせるためには、定期的な追肥が欠かせません。'}, {'name': '防虫ネット', 'link': 'https://amzn.to/3VEA7hV', 'reason': 'アブラムシやコナガから葉を守り、健康な株を維持します。'}],
    ...
    '小カブ': {
        ...
        'recurring_consumables': [{'name': '野菜用の化成肥料', 'link': 'https://amzn.to/4c5kX7s', 'reason': '根を甘く、大きく育てるための追肥は必須です。'}, {'name': '防虫ネット', 'link': 'https://amzn.to/3VEA7hV', 'reason': 'カブの葉は虫に好かれやすいので、ネットでしっかりガードしましょう。'}],
    ...
    'ミニトマト': {
        ...
        'recurring_consumables': [{'name': 'トマトの追肥用肥料', 'link': 'https://amzn.to/40aoawy', 'reason': '実をつけ続けるために、栄養豊富な追肥は欠かせません。'}, {'name': '病害虫対策スプレー', 'link': 'https://amzn.to/3VEA7hV', 'reason': 'アブラムシやうどんこ病の予防と対策に。一本あると安心です。'}],
    ...
    'きゅうり': {
        ...
        'recurring_consumables': [{'name': 'きゅうりの肥料', 'link': 'https://amzn.to/3GoDfE7', 'reason': '生育が早く栄養を大量に消費するため、定期的な追肥が収穫量を左右します。'}, {'name': '野菜用 活力剤', 'link': 'https://amzn.to/3Rk4uTf', 'reason': '生育が悪い時や、葉の色が薄い時に使うと元気になります。'}],
    ...
    'えだまめ': {
        ...
        'recurring_consumables': [{'name': '豆類専用の肥料', 'link': 'https://amzn.to/3TfX1EP', 'reason': '実入りを良くするために、リン酸・カリウムが豊富な肥料を使いましょう。'}, {'name': '防虫ネット', 'link': 'https://amzn.to/3VEA7hV', 'reason': 'カメムシなどの害虫から、大事な実を守るために有効です。'}],
    ...
    'なす': {
        ...
        'recurring_consumables': [{'name': 'なす用の肥料', 'link': 'https://amzn.to/4l1WcLW', 'reason': '長く収穫を楽しむ「秋なす」のためにも、肥料切れは絶対に避けましょう。'}, {'name': '支柱', 'link': 'https://amzn.to/3VHj53D', 'reason': '実が大きくなると重さで枝が折れることがあります。しっかりした支柱で支えましょう。'}],
    ...
    'タマネギ': {
        ...
        'recurring_consumables': [{'name': '野菜用の化成肥料', 'link': 'https://amzn.to/4c5kX7s', 'reason': '玉ねぎを大きく、甘くするための重要な追肥です。'}, {'name': '有機石灰', 'link': 'https://amzn.to/4eiAnmP', 'reason': '植え付け前に土に混ぜることで、土壌の酸度を調整し、生育を助けます。'}],
    ...
    'ピーマン': {
        ...
        'recurring_consumables': [{'name': 'ピーマン・パプリカの肥料', 'link': 'https://amzn.to/4kl8ldT', 'reason': '実を次々とならせるためには、定期的な栄養補給が鍵となります。'}, {'name': '支柱', 'link': 'https://amzn.to/3VHj53D', 'reason': 'たくさんの実がなると重くなるので、支柱でしっかりと支えてあげましょう。'}],
    ...
    'ミニハクサイ': {
        ...
        'recurring_consumables': [{'name': '野菜用の化成肥料', 'link': 'https://amzn.to/4c5kX7s', 'reason': '葉がしっかりと巻く（結球する）ために、追肥で栄養を補いましょう。'}, {'name': '防虫ネット', 'link': 'https://amzn.to/3VEA7hV', 'reason': 'アオムシなどの害虫から柔らかい葉を守るための必須アイテムです。'}],
    ...
    'ブロッコリー': {
        ...
        'recurring_consumables': [{'name': '野菜用の化成肥料', 'link': 'https://amzn.to/4c5kX7s', 'reason': '頂花蕾（中心の蕾）と側花蕾（脇の蕾）の両方を収穫するために追肥は重要です。'}, {'name': '防虫ネット', 'link': 'https://amzn.to/3VEA7hV', 'reason': 'ブロッコリー栽培の成功は、アオムシ対策ができるかで決まります。'}],
    ...
    'ニンジン': {
        ...
        'recurring_consumables': [{'name': '野菜用の化成肥料', 'link': 'https://amzn.to/4c5kX7s', 'reason': '根をまっすぐ太く育てるために、定期的な栄養補給を行いましょう。'}, {'name': 'バーミキュライト', 'link': 'https://amzn.to/3VHj53D', 'reason': '種まき後、土の上に薄く覆うと、乾燥を防ぎ発芽率がアップします。'}],
