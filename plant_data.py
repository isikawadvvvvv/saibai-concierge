...
PLANT_DATABASE = {
    'ベビーリーフ': {
        'category': '秋冬野菜', 'popularity': 1, 'base_temp': 5.0, 
        'image_url': 'https://images.pexels.com/photos/2551794/pexels-photo-2551794.jpeg', 'avg_gdd_per_day': 9,
    ...
    'コマツナ': {
        'category': '秋冬野菜', 'popularity': 2, 'base_temp': 5.0, 
        'image_url': 'https://images.pexels.com/photos/18066363/pexels-photo-18066363.jpeg', 'avg_gdd_per_day': 10,
    ...
    'ミニダイコン': {
        'category': '秋冬野菜', 'popularity': 3, 'base_temp': 5.0, 
        'image_url': 'https://images.pexels.com/photos/14982333/pexels-photo-14982333.jpeg', 'avg_gdd_per_day': 11,
    ...
    '小カブ': {
        'category': '秋冬野菜', 'popularity': 4, 'base_temp': 5.0, 
        'image_url': 'https://images.pexels.com/photos/28324/pexels-photo.jpg', 'avg_gdd_per_day': 12,
    ...
    'しそ': {
        'category': 'ハーブ', 'popularity': 5, 'base_temp': 15.0, 
        'image_url': 'https://images.pexels.com/photos/13532392/pexels-photo-13532392.jpeg', 'avg_gdd_per_day': 12,
    ...
    'ミニトマト': {
        'category': '夏野菜', 'popularity': 6, 'base_temp': 10.0, 
        'image_url': 'https://images.pexels.com/photos/7208483/pexels-photo-7208483.jpeg', 'avg_gdd_per_day': 15,
    ...
    'きゅうり': {
        'category': '夏野菜', 'popularity': 7, 'base_temp': 12.0, 
        'image_url': 'https://images.pexels.com/photos/7543157/pexels-photo-7543157.jpeg', 'avg_gdd_per_day': 20,
    ...
    'えだまめ': {
        'category': '夏野菜', 'popularity': 8, 'base_temp': 10.0, 
        'image_url': 'https://images.pexels.com/photos/2551790/pexels-photo-2551790.jpeg', 'avg_gdd_per_day': 18,
    ...
    'なす': {
        'category': '夏野菜', 'popularity': 9, 'base_temp': 12.0, 
        'image_url': 'https://images.unsplash.com/photo-1639428134238-b548770d4b77?q=80&w=987&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D', 'avg_gdd_per_day': 18,
    ...
    'タマネギ': {
        'category': '秋冬野菜', 'popularity': 10, 'base_temp': 4.0, 
        'image_url': 'https://images.pexels.com/photos/144234/onions-kitchen-bio-food-144234.jpeg', 'avg_gdd_per_day': 9,
    ...
    'ピーマン': {
        'category': '夏野菜', 'popularity': 11, 'base_temp': 15.0, 
        'image_url': 'https://images.pexels.com/photos/4943441/pexels-photo-4943441.jpeg', 'avg_gdd_per_day': 16,
    ...
    'ミニハクサイ': {
        'category': '秋冬野菜', 'popularity': 12, 'base_temp': 5.0, 
        'image_url': 'https://images.pexels.com/photos/5443209/pexels-photo-5443209.jpeg', 'avg_gdd_per_day': 13,
    ...
    'ブロッコリー': {
        'category': '秋冬野菜', 'popularity': 13, 'base_temp': 5.0, 
        'image_url': 'https://images.pexels.com/photos/4054358/pexels-photo-4054358.jpeg', 'avg_gdd_per_day': 15,
    ...
    'ニンジン': {
        'category': '秋冬野菜', 'popularity': 14, 'base_temp': 5.0, 
        'image_url': 'https://images.pexels.com/photos/143133/pexels-photo-143133.jpeg', 'avg_gdd_per_day': 14,
